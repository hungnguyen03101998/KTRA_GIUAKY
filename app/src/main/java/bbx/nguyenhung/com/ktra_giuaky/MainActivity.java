...
public class MainActivity extends AppCompatActivity {
    ...
    private void addControl() {
        ...
        tab3.setIndicator("",getResources().getDrawable(R.drawable.favoutite));
        tab.addTab(tab3);
        edttim = findViewById(R.id.edtbaihat);
        ...
        myarray1 = new myarrayAdapter(MainActivity.this,R.layout.layou2,list1);
        myarrray2 = new myarrayAdapter(MainActivity.this,R.layout.layou2,list2);
        myarray3 = new myarrayAdapter(MainActivity.this,R.layout.layou2,list3);
